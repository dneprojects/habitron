...
def _coord() -> MagicMock:
    ...
    coord.client.set_daytime_mode = AsyncMock()
    coord.client.set_alarm_mode = AsyncMock()
    coord.client.set_group_mode = AsyncMock()
    return coord
...
async def test_daytime_select_module_path() -> None:
    ...
    coord.client.set_daytime_mode.assert_awaited_with(3, False)
...
async def test_daytime_select_router_path() -> None:
    ...
    coord.client.set_daytime_mode.assert_awaited_with(0, DaytimeMode["day"].value)
...
async def test_alarm_select_module_path() -> None:
    ...
    coord.client.set_alarm_mode.assert_awaited_with(2, True)
...
async def test_group_select_uses_user_names() -> None:
    ...
    coord.client.set_group_mode.assert_awaited_with(4, 32)
...
def _hub_coord() -> MagicMock:
    ...
    coordinator.client.set_log_level = AsyncMock()
    return coordinator
...
async def test_logging_level_select_option() -> None:
    ...
    coordinator.client.set_log_level.assert_awaited_with(
...
async def test_base_mode_select_option_module_and_router() -> None:
    ...
    assert coord.client.set_group_mode.await_args.args[0] == 7

    rt_entity = HbtnMode(0, _router(), coord, 0)
    await rt_entity.async_select_option("night")
    assert coord.client.set_group_mode.await_args.args[0] == 0
...
async def test_alarm_select_router_path() -> None:
    ...
    await entity.async_select_option("on")
    coord.client.set_alarm_mode.assert_awaited_with(0, True)
...
async def test_group_select_module_and_router_paths() -> None:
    ...
    coord.client.set_group_mode.assert_awaited_with(5, 32)

    rt_entity = HbtnSelectGroupModePush(0, _router(), coord, 0)
    await rt_entity.async_select_option("absent")
    coord.client.set_group_mode.assert_awaited_with(0, 16)
